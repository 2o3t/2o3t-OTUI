<template>
    <div ot class="ot-pagination" :size="$otSize" :class="$style.root">
        <span ot v-bind="_itemUIColors" :class="$style.item" @click="handlePrevPage" :disabled="current === 1" :size="$otSize" :round="round">
            <slot name="prev">
                <ot-icon icon="angle-left"></ot-icon>
            </slot>
        </span>
        ...
        <span ot v-bind="_itemUIColors" :class="$style.item" @click="handleNextPage" :disabled="current === pageCount" :size="$otSize" :round="round">
            <slot name="next">
                <ot-icon icon="angle-right"></ot-icon>
            </slot>
        </span>
    </div>
</template>
